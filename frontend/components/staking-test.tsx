    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">Your Current Stake</p>
            <p className="text-2xl font-bold">{userStake} USDC</p>
          </div>
        </div>
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p>• This is a test component for debugging staking issues</p>
          <p>• Make sure you have USDC on Arbitrum Sepolia</p>
          <p>• Gas fees are now fixed to prevent high fee errors</p>
